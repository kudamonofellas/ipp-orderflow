...
export const ICONS = {
  ...
  circleArrowUp: "hugeicons:circle-arrow-up-01",
  circleArrowDown: "hugeicons:circle-arrow-down-01",
  circleArrowRight: "hugeicons:circle-arrow-right-01",
  circleArrowLeft: "hugeicons:circle-arrow-left-01",
  ...
  documentWait: "hugeicons:clipboard-clock",
